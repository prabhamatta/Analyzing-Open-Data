...
cd ..
ln -s /Users/prabha/classes/spring2014/opendata/pydata-book pydata-book
...
time_zones = [rec.get('tz',"LOL") for rec in records] #gives a value or gives none if doesn't exist ==> safeway of getting from dict
#time_zones = [rec['tz'] for rec in records] #what is the difference ??
...
# dataframe records is a list of dicts
# for eg:
...
# value_counts similar to wordcount
